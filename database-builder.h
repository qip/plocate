...
public:
	...
	virtual void add_file(std::string filename, dir_time dt, int64_t filesize = -1, int64_t allocated = -1, const std::string &checksum = "") = 0;
...
public:
	...
	DatabaseReceiver *start_corpus(bool store_dir_times, bool store_filesizes = false, bool store_checksums = false);
